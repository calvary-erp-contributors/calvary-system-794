...
@RestController
@RequestMapping("/api/calvary-system-794-kafka")
public class CalvarySystem794KafkaResource {

    private final Logger log = LoggerFactory.getLogger(CalvarySystem794KafkaResource.class);
    ...
    public CalvarySystem794KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
