...
@RestController
@RequestMapping("/api")
public class SalesReceiptEmailPersonaResource {

    private final Logger log = LoggerFactory.getLogger(SalesReceiptEmailPersonaResource.class);
    ...
    public SalesReceiptEmailPersonaResource(
