...
@RestController
@RequestMapping("/api")
public class ReceiptEmailRequestResource {

    private final Logger log = LoggerFactory.getLogger(ReceiptEmailRequestResource.class);
    ...
    public ReceiptEmailRequestResource(
