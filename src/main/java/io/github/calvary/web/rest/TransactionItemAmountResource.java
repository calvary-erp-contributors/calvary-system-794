...
@RestController
@RequestMapping("/api")
public class TransactionItemAmountResource {

    private final Logger log = LoggerFactory.getLogger(TransactionItemAmountResource.class);
    ...
    public TransactionItemAmountResource(
