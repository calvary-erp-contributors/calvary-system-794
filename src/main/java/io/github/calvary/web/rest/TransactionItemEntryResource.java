...
@RestController
@RequestMapping("/api")
public class TransactionItemEntryResource {

    private final Logger log = LoggerFactory.getLogger(TransactionItemEntryResource.class);
    ...
    public TransactionItemEntryResource(
