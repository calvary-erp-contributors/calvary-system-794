...
/**
 * REST controller for managing {@link io.github.calvary.domain.TransactionAccount}.
 */
@RestController
@RequestMapping("/api")
public class TransactionAccountResource {
    ...
    public ResponseEntity<TransactionAccountDTO> updateTransactionAccount(
        ...
        TransactionAccountDTO result = transactionAccountService.update(transactionAccountDTO);
        return ResponseEntity
            .ok()
