...
class DealerTypeSearchRepositoryInternalImpl implements DealerTypeSearchRepositoryInternal {
    ...
    DealerTypeSearchRepositoryInternalImpl(ElasticsearchRestTemplate elasticsearchTemplate, DealerTypeRepository repository) {
    ...
    public Page<DealerType> search(Query query) {
        ...
        List<DealerType> hits = searchHits.map(SearchHit::getContent).stream().collect(Collectors.toList());
