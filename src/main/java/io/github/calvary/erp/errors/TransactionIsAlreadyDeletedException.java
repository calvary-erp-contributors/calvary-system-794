...
public class TransactionIsAlreadyDeletedException extends BadRequestAlertException {

    public TransactionIsAlreadyDeletedException(String defaultMessage, String entityName, String errorKey) {
