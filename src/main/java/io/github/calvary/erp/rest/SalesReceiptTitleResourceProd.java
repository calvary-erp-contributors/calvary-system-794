...
public class SalesReceiptTitleResourceProd {

    private final Logger log = LoggerFactory.getLogger(SalesReceiptTitleResourceProd.class);
    ...
    public SalesReceiptTitleResourceProd(
