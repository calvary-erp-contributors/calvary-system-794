...
public class TransactionCurrencyResourceProd {

    private final Logger log = LoggerFactory.getLogger(TransactionCurrencyResourceProd.class);
    ...
    public TransactionCurrencyResourceProd(
