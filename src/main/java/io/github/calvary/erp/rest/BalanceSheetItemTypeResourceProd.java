...
public class BalanceSheetItemTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(BalanceSheetItemTypeResourceProd.class);
    ...
    public BalanceSheetItemTypeResourceProd(
    ...
    public ResponseEntity<BalanceSheetItemTypeDTO> updateBalanceSheetItemType(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, balanceSheetItemTypeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<BalanceSheetItemTypeDTO> partialUpdateBalanceSheetItemType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, balanceSheetItemTypeDTO.getId().toString())
        );
    }
