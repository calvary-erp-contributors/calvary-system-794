...
public class AccountTransactionResourceProd {

    private final Logger log = LoggerFactory.getLogger(AccountTransactionResourceProd.class);
    ...
    public AccountTransactionResourceProd(
