...
public class SalesReceiptCompilationResourceProd {

    private final Logger log = LoggerFactory.getLogger(SalesReceiptCompilationResourceProd.class);
    ...
    public SalesReceiptCompilationResourceProd(
