...
public class AccountingEventResourceProd {

    private final Logger log = LoggerFactory.getLogger(AccountingEventResourceProd.class);
    ...
    public AccountingEventResourceProd(
    ...
    public ResponseEntity<AccountingEventDTO> updateAccountingEvent(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, accountingEventDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<AccountingEventDTO> partialUpdateAccountingEvent(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, accountingEventDTO.getId().toString())
        );
    }
