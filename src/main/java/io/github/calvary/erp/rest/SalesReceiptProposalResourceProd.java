...
import io.github.calvary.erp.SalesReceiptProposalProtocolService;
 ...
 */
@RestController("salesReceiptProposalResourceProd")
@RequestMapping("/api/app")
public class SalesReceiptProposalResourceProd {

    private final Logger log = LoggerFactory.getLogger(SalesReceiptProposalResourceProd.class);
    ...
    private final io.github.calvary.erp.SalesReceiptProposalProtocolService salesReceiptProposalProtocolService;

    public SalesReceiptProposalResourceProd(
        ...
        SalesReceiptProposalProtocolService salesReceiptProposalProtocolService
    ) {
        ...
        this.salesReceiptProposalProtocolService = salesReceiptProposalProtocolService;
    }
    ...
    @Async
    void proposeReceipts(SalesReceiptProposalDTO result) {
        salesReceiptProposalProtocolService.salesReceiptPosting(result);
    }
