...
public class TransactionAccountTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(TransactionAccountTypeResourceProd.class);
    ...
    public TransactionAccountTypeResourceProd(
