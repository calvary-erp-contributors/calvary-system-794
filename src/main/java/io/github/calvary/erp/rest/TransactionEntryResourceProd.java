...
public class TransactionEntryResourceProd {

    private final Logger log = LoggerFactory.getLogger(TransactionEntryResourceProd.class);
    ...
    public ResponseEntity<TransactionEntryDTO> updateTransactionEntry(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, transactionEntryDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TransactionEntryDTO> partialUpdateTransactionEntry(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, transactionEntryDTO.getId().toString())
        );
    }
