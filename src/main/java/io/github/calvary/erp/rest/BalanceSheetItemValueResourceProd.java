...
public class BalanceSheetItemValueResourceProd {

    private final Logger log = LoggerFactory.getLogger(BalanceSheetItemValueResourceProd.class);
    ...
    public BalanceSheetItemValueResourceProd(
