...
/**
 * REST controller for managing {@link io.github.calvary.domain.ApplicationUser}.
 */
@RestController
@RequestMapping("/api/app")
public class ApplicationUserResourceProd {

    private final Logger log = LoggerFactory.getLogger(ApplicationUserResourceProd.class);
