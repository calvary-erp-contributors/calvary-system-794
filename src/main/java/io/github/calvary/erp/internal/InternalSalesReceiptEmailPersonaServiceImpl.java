...
import io.github.calvary.erp.repository.InternalSalesReceiptEmailPersonaRepository;
...
@Service
@Transactional
public class InternalSalesReceiptEmailPersonaServiceImpl implements InternalSalesReceiptEmailPersonaService {

    private final Logger log = LoggerFactory.getLogger(InternalSalesReceiptEmailPersonaServiceImpl.class);

    private final InternalSalesReceiptEmailPersonaRepository salesReceiptEmailPersonaRepository;
    ...
    public InternalSalesReceiptEmailPersonaServiceImpl(
        InternalSalesReceiptEmailPersonaRepository salesReceiptEmailPersonaRepository,
