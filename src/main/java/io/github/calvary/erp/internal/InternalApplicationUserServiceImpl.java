...
@Service
@Transactional
public class InternalApplicationUserServiceImpl implements InternalApplicationUserService {

    private final Logger log = LoggerFactory.getLogger(InternalApplicationUserServiceImpl.class);
    ...
    public InternalApplicationUserServiceImpl(
