...
@Service
@Transactional
public class InternalDealerServiceImpl implements InternalDealerService {

    private final Logger log = LoggerFactory.getLogger(InternalDealerServiceImpl.class);
    ...
    public InternalDealerServiceImpl(
