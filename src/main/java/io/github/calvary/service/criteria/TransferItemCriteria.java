...
/**
 * Criteria class for the {@link io.github.calvary.domain.TransferItem} entity. This class is used
 * in {@link io.github.calvary.web.rest.TransferItemResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /transfer-items?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TransferItemCriteria implements Serializable, Criteria {
    ...
    public TransferItemCriteria() {}

    public TransferItemCriteria(TransferItemCriteria other) {
    ...
    @Override
    public TransferItemCriteria copy() {
        return new TransferItemCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TransferItemCriteria that = (TransferItemCriteria) o;
        return (
