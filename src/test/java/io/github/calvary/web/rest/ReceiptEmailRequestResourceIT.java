...
class ReceiptEmailRequestResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/receipt-email-requests";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/receipt-email-requests";
