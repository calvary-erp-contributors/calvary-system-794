...
class AccountBalanceReportItemResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/account-balance-report-items";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/account-balance-report-items";
        ...
        restAccountBalanceReportItemMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedAccountBalanceReportItem.getId())
                    ...
                    .content(TestUtil.convertObjectToJsonBytes(partialUpdatedAccountBalanceReportItem))
            )
            .andExpect(status().isOk());
