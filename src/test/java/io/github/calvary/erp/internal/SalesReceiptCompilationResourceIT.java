...
import io.github.calvary.web.rest.SalesReceiptCompilationResource;
...
class SalesReceiptCompilationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/sales-receipt-compilations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/sales-receipt-compilations";
