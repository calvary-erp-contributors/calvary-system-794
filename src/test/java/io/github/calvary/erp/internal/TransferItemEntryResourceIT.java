...
import io.github.calvary.web.rest.TransferItemEntryResource;
...
class TransferItemEntryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/transfer-item-entries";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/transfer-item-entries";
