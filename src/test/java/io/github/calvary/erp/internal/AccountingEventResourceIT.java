...
import io.github.calvary.web.rest.AccountingEventResource;
...
class AccountingEventResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/accounting-events";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/accounting-events";
