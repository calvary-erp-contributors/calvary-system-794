...
import io.github.calvary.domain.*;
...
import io.github.calvary.web.rest.SalesReceiptResource;
...
class SalesReceiptResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/sales-receipts";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/sales-receipts";
