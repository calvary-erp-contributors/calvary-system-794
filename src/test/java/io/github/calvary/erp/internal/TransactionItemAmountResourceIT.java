...
import io.github.calvary.web.rest.TransactionItemAmountResource;
...
class TransactionItemAmountResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/transaction-item-amounts";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/transaction-item-amounts";
