...
import io.github.calvary.web.rest.BalanceSheetItemValueResource;
...
class BalanceSheetItemValueResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/balance-sheet-item-values";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/balance-sheet-item-values";
