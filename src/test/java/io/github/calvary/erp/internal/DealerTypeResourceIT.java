...
import io.github.calvary.web.rest.DealerTypeResource;
...
class DealerTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/dealer-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/dealer-types";
