...
import io.github.calvary.web.rest.EventTypeResource;
...
class EventTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/event-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/event-types";
