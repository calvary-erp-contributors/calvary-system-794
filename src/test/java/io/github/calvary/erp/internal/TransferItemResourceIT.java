...
import io.github.calvary.web.rest.TransferItemResource;
...
class TransferItemResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/transfer-items";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/transfer-items";
