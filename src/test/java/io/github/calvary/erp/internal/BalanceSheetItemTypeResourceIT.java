...
import io.github.calvary.web.rest.BalanceSheetItemTypeResource;
...
class BalanceSheetItemTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/balance-sheet-item-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/balance-sheet-item-types";
    ...
    void putExistingBalanceSheetItemType() throws Exception {
        ...
        BalanceSheetItemType updatedBalanceSheetItemType = balanceSheetItemTypeRepository.findById(balanceSheetItemType.getId()).get();
