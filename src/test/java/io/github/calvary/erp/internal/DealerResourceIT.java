...
import io.github.calvary.web.rest.DealerResource;
...
class DealerResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/dealers";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/dealers";
