...
import io.github.calvary.web.rest.TransactionEntryResource;
...
class TransactionEntryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/transaction-entries";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/transaction-entries";
