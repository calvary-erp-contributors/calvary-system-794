...
import io.github.calvary.web.rest.TransactionAccountTypeResource;
...
class TransactionAccountTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/transaction-account-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/transaction-account-types";
